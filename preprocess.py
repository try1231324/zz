...
def scale_crop_nonorm(input_size):
    t_list = [
        transforms.CenterCrop(input_size),
        transforms.ToTensor(),
    ]
...
def scale_random_nonorm( input_size ):
    t_list = [
        transforms.RandomCrop(input_size),
        transforms.ToTensor(),
    ]
...
def get_transform(name='imagenet', input_size=None,
    ...
    if name == 'imagenet':
    #if name == 'imagenet' or name == 'miniimagenet':
        ...
        if augment:
            return scale_random_nonorm(input_size=input_size)
        else:
            return scale_crop_nonorm(input_size=input_size)
