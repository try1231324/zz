...
_IMAGENET_MAIN_PATH = '/cwj/training-mixed-precision-quantized-networks/imagenet'
_MINIIMAGENET_MAIN_PATH = '/cwj/training-mixed-precision-quantized-networks/miniimagenet'
_DATASETS_MAIN_PATH = ''
...
_dataset_path = {
    ...
    'miniimagenet': {
        'train': os.path.join(_MINIIMAGENET_MAIN_PATH, 'train'),
        'val': os.path.join(_MINIIMAGENET_MAIN_PATH, 'val')
    },
}
...
def get_dataset(name, split='train', transform=None,
    ...
    if name == 'mnist':
        ...
        path = _dataset_path['miniimagenet'][split]
